...
suspend fun loadJson(context: Context) = withContext(Dispatchers.IO) {
    ...
    try {
        ...
        if (connection.responseCode != 200) {
            ...
            baseInstallUrl = "https://github.com/inotia00/after_vanced_origin/raw/vanced/api/v1"
        }
    } catch (e: IOException) {
        baseInstallUrl = "https://github.com/inotia00/after_vanced_origin/raw/vanced/api/v1"
...
const val baseUrl = "https://github.com/inotia00/after_vanced_origin/raw/vanced/api/v1"